...
export const api = {
  ...
  admin: {
    ...
    pendingOwners: () => request('GET', '/admin/pending-owners'),
    approveOwner: (id: any) => request('POST', `/admin/users/${id}/approve-owner`, {}),
    rejectOwner: (id: any, d: any) => request('POST', `/admin/users/${id}/reject-owner`, d),
